...
const CONTENT_SOURCE_OPTIONS = [
  {
    ...
    description: "Create, edit, and delete files through the Contentstack OS UI.",
  },
  {
    value: "git" as const,
    Icon: GitBranch,
...
const gadgetsHighlightStyleDark = HighlightStyle.define([
  { tag: t.comment, color: "#7c7a94", fontStyle: "italic" },
  {
    tag: [
      t.keyword,
      t.moduleKeyword,
  ...
  { tag: t.operator, color: "#9a97b0" },
  { tag: [t.string, t.special(t.string), t.regexp, t.escape], color: "#48dba2" },
  { tag: [t.number, t.bool, t.null, t.atom], color: "#ffbc36" },
  { tag: [t.typeName, t.className, t.namespace], color: "#ffbc36" },
  { tag: [t.function(t.variableName), t.function(t.propertyName)], color: "#74b4ff" },
  { tag: [t.variableName, t.propertyName], color: "#e6e4f0" },
  { tag: t.constant(t.variableName), color: "#ffbc36" },
  { tag: t.standard(t.variableName), color: "#74b4ff" },
  { tag: [t.punctuation, t.separator, t.bracket, t.paren, t.brace], color: "#9a97b0" },
  { tag: t.tagName, color: "#ff735f" },
  { tag: t.attributeName, color: "#ffbc36" },
  { tag: t.attributeValue, color: "#48dba2" },
  { tag: t.heading, color: "#ada4f4" },
  { tag: t.url, color: "#48dba2" },
]);

const gadgetsEditorThemeDark = EditorView.theme(
  {
    "&": { color: "#e6e4f0", backgroundColor: "transparent", height: "100%", fontSize: "13px" },
    "&.cm-focused": { outline: "none" },
    ".cm-scroller": {
      fontFamily: monoFont,
      lineHeight: "1.7",
    ...
    ".cm-scroller::-webkit-scrollbar-track": { background: "transparent" },
    ".cm-content": { padding: "12px 0", caretColor: "#e6e4f0" },
    ".cm-line": { padding: "0 16px" },
    ".cm-gutters": {
      backgroundColor: "transparent",
      border: "none",
    ...
    ".cm-activeLineGutter": { backgroundColor: "transparent", color: "#9a97b0" },
    ".cm-cursor, .cm-dropCursor": { borderLeftColor: "#e6e4f0" },
    "&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": {
      backgroundColor: "#3b3468",
    },
  },
  { dark: true },
);
