  ...
  return (
    ...
    >
      ...
      <div className="themed-floating-shadow-lg relative w-full max-w-xl overflow-hidden rounded-xl border border-kumo-line bg-kumo-base">
                  ...
                  {group.items.map((cmd, j) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {cmd.hint && (
                          <span className="shrink-0 text-ui-2xs text-kumo-subtle">{cmd.hint}</span>
                        )}
                      </button>
                    )
                  })}
        ...
        <div className="flex items-center gap-3 border-t border-kumo-line px-3.5 py-2 text-ui-2xs text-kumo-subtle">
