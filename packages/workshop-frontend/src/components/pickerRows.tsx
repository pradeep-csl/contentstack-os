...
export const PICKER_CAPTION =
  'text-ui-2xs font-medium uppercase leading-4 tracking-[0.06em] text-kumo-subtle'
...
export function TabHint() {
  return (
    <kbd
      aria-hidden="true"
      className="flex-shrink-0 rounded border border-kumo-line bg-kumo-base px-1 py-px font-sans text-ui-2xs font-medium leading-4 tracking-[0.02em] text-kumo-subtle"
    >
      Tab
    </kbd>
  )
