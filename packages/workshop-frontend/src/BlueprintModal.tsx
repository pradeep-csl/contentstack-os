            ...
            {formMode !== 'list' ? (
              <>
                <div className="flex-1 overflow-y-auto chat-panel space-y-5 px-4 py-5 sm:px-6">
                    ...
                    <div className="rounded-xl border border-kumo-line bg-kumo-base p-3">
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="m-0 mt-0.5 text-ui-xs font-normal text-kumo-subtle">
                      ...
                      {clearScreenshot && !newScreenshotUrl && (
                        <div className="mt-3 rounded-lg border border-dashed border-kumo-line bg-kumo-tint px-3 py-2 text-ui-xs text-kumo-default">
                  ...
                  {bindingsLoading ? (
                    ...
                    <section>
                      ...
                      <p className="m-0 mb-3 text-ui-xs font-normal text-kumo-subtle">
                ...
                <div className="border-t border-kumo-line px-4 py-4 sm:px-6">
                  {createError && (
                    <div className="mb-3 flex items-start gap-2 rounded-lg border border-l-2 border-l-kumo-brand border-y-kumo-line border-r-kumo-line bg-kumo-base px-3 py-2 text-ui-xs leading-[18px] font-normal text-kumo-default">
      ...
      >
        <div className="flex w-full flex-wrap items-center gap-3">
          <div className="min-w-0 flex-1">
            <p className="m-0 truncate text-ui-md font-semibold text-kumo-danger">
              Delete "{bp.title}"?
            </p>
            <p className="m-0 mt-0.5 text-ui-xs font-normal text-kumo-subtle">
          ...
          <button
            ...
            disabled={isDeleting}
            className="inline-flex h-7 shrink-0 cursor-pointer items-center rounded-md bg-kumo-danger px-2.5 text-ui-xs font-medium text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isDeleting}
            className="inline-flex h-7 shrink-0 cursor-pointer items-center rounded-md bg-transparent px-2.5 text-ui-xs font-medium text-kumo-subtle transition-colors hover:bg-kumo-tint hover:text-kumo-default disabled:cursor-not-allowed disabled:opacity-50"
          >
            Cancel
          </button>
        </div>
  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-wrap items-center gap-3">
        <p className="m-0 min-w-0 flex-1 truncate text-ui-lg leading-5 font-semibold text-kumo-default">
          {bp.title}
        </p>

        <span
          className={`inline-flex shrink-0 items-center gap-1.5 rounded-full border px-2 py-0.5 text-ui-2xs ${
            bp.dirty
...
function GhostButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex h-7 cursor-pointer items-center gap-1.5 rounded-md bg-transparent px-2 text-ui-xs font-medium text-kumo-subtle transition-colors hover:bg-kumo-tint hover:text-kumo-default"
    >
      {icon}
      {children}
    </button>
