...
<p>Authorization complete. You may close this tab and return to Contentstack OS.</p></body></html>`;
...
const INVALID_LINK_HTML = page("Authorization Link Expired", "#d97706",
  "This authorization link is invalid or has expired. Please return to Contentstack OS and try again.");
...
export class GatekeeperVendor extends WorkerEntrypoint<Env> implements GatekeeperVendorIface {
  async describe(): Promise<VendorDescription> {
    return {
      ...
      description:
        "Connect your Atlassian Confluence site to let Contentstack OS search, read, and edit the pages, " +
